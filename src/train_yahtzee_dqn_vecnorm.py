...
# -----------------------------
# Construccion del modelo DQN
# -----------------------------
def make_dqn(vec_env, args, *, n_steps=None, exploration_fraction=None, exploration_initial_eps=None):
    policy_kwargs = dict(net_arch=[256, 256])  # DQN: una sola red Q con net_arch
    # (policy_kwargs correcto para DQN)  # SB3 doc: custom policy/net_arch
    # https://github.com/DLR-RM/stable-baselines3/blob/master/docs/guide/custom_policy.rst
...
def build_argparser():
    ...
    parser.add_argument("--buffer_size", type=int, default=1000000, help="Tamaño del buffer de replay")
    ...
    # n-step returns (SB3 >= 2.7.0)
    parser.add_argument("--n_steps", type=int, default=3, help="n-step returns (SB3>=2.7.0)")
    # Frecuencias / target
